...
class PositionEmbeddingSine(nn.Module):
    ...
    def __repr__(self):
        ...
        rep_str = rep_str + f"num_pos_feats={str(self.num_pos_feats)}, "
        rep_str = rep_str + f"temperature={str(self.temperature)}, "
        rep_str = rep_str + f"normalize={str(self.normalize)}, "
        rep_str = rep_str + f"offset={str(self.offset)})"
        return rep_str
