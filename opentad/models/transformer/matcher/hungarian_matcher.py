...
class HungarianMatcher(nn.Module):
    ...
    def __repr__(self):
        ...
        rep_str = rep_str + f"cost_class={str(self.cost_class)}, "
        rep_str = rep_str + f"cost_bbox={str(self.cost_bbox)}, "
        rep_str = rep_str + f"cost_giou={str(self.cost_giou)}, "
        rep_str = rep_str + f"alpha={str(self.alpha)}, "
        rep_str = rep_str + f"gamma={str(self.gamma)})"
        return rep_str
