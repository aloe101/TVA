...
model = dict(backbone=dict(
        ...
        custom=dict(
            pretrain='/tmp/tad/OpenTAD/pretrained/vit-base-p16_videomae-k400-pre_16x4x1_kinetics-400_20221013-860a3cd3.pth',   #"pretrained/vit-base-p16_videomae-k400-pre_16x4x1_kinetics-400_20221013-860a3cd3.pth",
...
solver = dict(
    test=dict(batch_size=12, num_workers=12),
    clip_grad_norm=1,
    amp=True,
    fp16_compress=True,
    static_graph=True,
...
work_dir = "exps/thumos/attacktad/transfer"
