...
model = dict(backbone=dict(
    ...
    projection=dict(in_channels=768, input_pdrop=0.2, freeze_detector=False),
    )

solver = dict(
    train=dict(batch_size=8, num_workers=1),
...
work_dir = "exps/thumos/attacktad/actionformer_videomae_b_768x1_160_test"
